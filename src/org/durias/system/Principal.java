...
public class Principal extends Application {
    ...
    public void menuPrincipalView() {
        try {
            MenuPrincipalControlador menuPrincipalView = (MenuPrincipalControlador) cambiarEscena("MenuPrincipalView.fxml", 1020, 580);
    ...
    public void DetalleCompras() {
        try {
            MenuDetalleCompraControlador DetalleCompra = (MenuDetalleCompraControlador) cambiarEscena("MenuDetalleCompra.fxml", 1175, 597);
